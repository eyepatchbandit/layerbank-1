...
Deploy with the included `netlify.toml`. For local end-to-end function testing, use `npx netlify dev` rather than the plain Vite development command. Running `npm run dev` alone does not expose `/.netlify/functions/send-survey`.
